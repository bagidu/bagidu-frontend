  ...
  <div id="donate" class="bg-white h-screen">
    <div id="container" class="md:w-1/2 lg:w-1/3 m-auto bg-white">
      ...
      <div id="amount" class="px-4 pb-4">
        <div class="flex flex-row border-2 border-green-400 rounded items-center bg-white text-gray-700">
        ...
        <div id="amount-preset" class="flex flex-row mt-4">
          <div
            ...
            :key="item.value"
            class="amount-preset-item px-3 py-2 rounded border-2 border-green-400 bg-white flex-grow text-center text-xl text-gray-700 font-semibold cursor-pointer select-none"
            :class="{
      ...
      <div id="name" class="px-4 pb-4">
        <input
          ...
          type="text"
          class="flex-grow rounded border-2 border-green-400 px-3 py-1 w-full outline-none  text-lg font-normal"
        >
      </div>
      <!-- Message -->
      <div id="message" class="px-4 pb-4">
        <textarea
          ...
          class="flex-grow rounded border-2 border-green-400 px-3 py-1 w-full outline-none  text-xl font-normal text-gray-700"
          rows="2"
        />
      </div>
      <!-- Button -->
